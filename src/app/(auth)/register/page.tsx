    ...
    <main className="relative mx-auto flex min-h-dvh w-full max-w-md flex-col justify-center px-4 py-10">
      <section ref={cardRef} className="surface-card p-6 opacity-0 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="meta mb-2 block">Username</label>
            <input
          ...
          <div>
            <label className="meta mb-2 block">Display Name (optional)</label>
            <input
              className="keta-input"
              placeholder="e.g. Spencer S."
              value={displayName}
          ...
          <div>
            <label className="meta mb-2 block">Confirm Password</label>
            <input
              type="password"
              className="keta-input"
