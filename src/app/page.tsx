  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <path
          id="horse2"
          d="M800,650 C800,650 785,570 792,530 C800,490 818,470 835,450 C845,430 838,410 843,390 C848,370 862,358 866,338 C870,318 861,298 870,287 C879,276 900,280 910,265 C920,250 914,230 923,220 C932,210 952,214 957,199 C962,184 947,164 956,154 C966,144 986,148 994,138 C1002,128 997,108 1007,103 C1012,123 1006,138 1016,148 C1026,158 1042,152 1047,167 C1052,182 1036,197 1041,212 C1046,227 1062,227 1067,242 C1072,257 1062,272 1067,287 C1072,302 1093,307 1093,322 C1093,337 1077,348 1082,363 C1087,378 1107,377 1107,393 C1107,413 1086,422 1091,443 C1096,463 1117,468 1117,488 C1117,508 1096,519 1101,539 C1106,559 1127,563 1121,583 C1115,603 1090,603 1085,624 C1080,644 1094,658 1089,679"
          stroke="white"
          strokeWidth="2"
          fill="none"
          strokeLinecap="round"
      ...
      >
        ...
        <div className="text-center mb-8">
          <h1
            ref={titleRef}
            className="text-5xl font-bold gradient-text tracking-tight mb-2"
          >
            Ketamovies
          </h1>
          <p className="text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>
            Watch movies. Log the vibes.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            {mode === "join" ? (
              <div>
                ...
                <input
                  className="keta-input font-mono tracking-widest uppercase"
                  placeholder="ABCD1"
                  value={roomCode}
